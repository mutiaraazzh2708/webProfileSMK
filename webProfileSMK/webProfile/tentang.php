...
<!-- Hero section -->
  <section class="hero-tentang">
      <div class="container">
            <h1><i class="fas fa-info-circle me-3"></i>Tentang SIG SMK Padang</h1>
            <p>Sistem Informasi Geografis untuk memetakan lokasi dan profil lengkap Sekolah Menengah Kejuruan Negeri di Kota Padang, Sumatera Barat</p>
        </div>
  </section>
